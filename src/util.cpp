...
const char * const BITCOIN_PID_FILENAME = "bitgreend.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitgreen-alpha";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitgreen-alpha";
#else
    // Unix
    return pathRet / ".bitgreen-alpha";
#endif
#endif
}
